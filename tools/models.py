...
def train(network, X_train, y_train, epochs=500, earlystopping=True, tensorboard=False, store=False, verbose=False, prefix='.'):
    ...
    if tensorboard:
        ...
        log_dir = f'{prefix}/tensorboardlogs/{network.name}/{randomsuffix}'
